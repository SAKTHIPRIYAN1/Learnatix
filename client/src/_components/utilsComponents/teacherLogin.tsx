...
const TeacherLogin = () => {
  ...
  return (
    <div className="text-[15px] z-[2] border border-slate-700 w-[500px] bg-[rgba(6,11,22,0.46)] rounded-lg p-6 flex flex-col items-center justify-center">
      <h1 className="text-white text-4xl mb-4">Teacher Login</h1>
      ...
      <SignIn.Root>
        ...
        >
          ...
          <p className="text-primary mt-2">
            ...
            <Link
             href="/sign-up/teacher"
              className="underline decoration-slate-400 hover:cursor-pointer font-semibold" onClick={()=>{console.log("lnk clicked!!!")}}
            >
              Sign Up
            </Link>
          </p>
          ...
          {/* Continue as Student & Sign-up buttons */}
          <div
